function dataArray = getDataStructureThreeLinkUr5e()
%{
GETDATASTRUCTURETHREELINKUR5E This simple function defines the type of data that we
...
the end-effector.
    ...
    OUTPUT(s):
        dataArray - [1 x N] array of strings representing data to be 
                    ...
                    format.
%}
dataArray = ["q1","q2","q3","x_ddot","y_ddot","z_ddot"];
