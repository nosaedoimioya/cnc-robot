function [V,R,polarToCartesian] = getPolarCoordinatesThreeLinkUr5e(numOfPositions,robot)
%{
GETPOLARCOORDINATESTHREELINKUR5E takes in a struct with the number of V and R
...
polarToCartesian = @threeLinkUr5e_polar_to_cartesian;
end