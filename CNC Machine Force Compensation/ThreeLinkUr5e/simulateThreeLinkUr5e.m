function [simTime,simInputs,simOutputs] = simulateThreeLinkUr5e(trajectory,robot,inTaskSpace,Ts,records)
%{
SIMULATETHREELINKUR5E takes in a trajectory and simulates it on the UR5e robot
...
if inTaskSpace
    ...
    % Simulate
    [t,P] = ode45(@(t,P) threeLinkUr5e_flexible_joint_tsp_inv_dynamics(t,P,td,Xd,robot),td,P0);
...
%         "q5","q5_dot","q6","q6_dot"];
    ...
    % Simulate
    [t,Q] = ode45(@(t,Q) threeLinkUr5e_flexible_joint_inv_dynamics(t,Q,td,Qd,robot),td,Q0);
