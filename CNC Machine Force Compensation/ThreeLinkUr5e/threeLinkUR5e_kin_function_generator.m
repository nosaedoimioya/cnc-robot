...
R_4=[cos(0) -sin(0) 0;
     sin(0)*cos(alpha_3) cos(0)*cos(alpha_3) -sin(alpha_3);
     sin(0)*sin(alpha_3) cos(0)*sin(alpha_3)  cos(alpha_3)];
...
%o=zeros(3,7);
J_o1=[R_1(:,3),zeros(3,2)];
J_o2=[R_1(:,3),R_20(:,3),zeros(3,1)];
J_o3=[R_1(:,3),R_20(:,3),R_30(:,3)];
