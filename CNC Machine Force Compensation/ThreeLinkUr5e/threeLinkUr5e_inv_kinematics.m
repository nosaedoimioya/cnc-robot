function Q = threeLinkUr5e_inv_kinematics(x,y,z,phi,theta,psi,frame,q_start)
%{
THREELINKUR5E_INV_KINEMATICS takes x, y and z axis vectors of the robot end-effector
...
% DH parameters for ThreeLinkUr5e
...
if ~strcmp(frame,'base')
    ...
    % Now its a row vector, add an additional 0 for the last fixed joint
    q_start = [q_start,0];
...
for i = 1:N
    ...
    % 4 (numSolutions)] matrix
    theta_options = threeLinkUr5e_algorithm_invKin(desired_pos,numJoints,a,d,alpha);
